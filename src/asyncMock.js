const products = [
    ...
    {
    id:'3', name: 'Set  Gamer MAC', price: 32000, category: 'Perifericos', img: 'https://http2.mlstatic.com/D_NQ_NP_743308-MLA45480040140_042021-O.webp', stock: 30, description: 'Normal llaves: 104. Dimensiones del teclado: aproximadamente 455*175*45mm. Tipo de interfaz: Usb (conexión inalámbrica de 2,4 GHz). Capacidad de la BATERÍA INTEGRADA: 3000mAh. Soporte del sistema: Windows 7 / 8 / 10 / Vista / XP / Mac OS / Linux y lo último. Color: Arco Iris negro, azul blanco plateado'
    },
]
